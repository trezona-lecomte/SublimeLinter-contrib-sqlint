...
[![Build Status](https://travis-ci.org/SublimeLinter/SublimeLinter-contrib-sqlint.svg?branch=master)](https://travis-ci.org/SublimeLinter/SublimeLinter-contrib-sqlint)
...
Once you have installed and configured `sqlint`, you can proceed to install the SublimeLinter-contrib-sqlint plugin if it is not yet installed.
...
1. When the plugin list appears, type `sqlint`. Among the entries you should see `SublimeLinter-contrib-sqlint`. If that entry is not highlighted, use the keyboard or mouse to select it.
